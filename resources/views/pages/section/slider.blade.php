        ...
        <ul class="slides">
            @foreach ($sliders as $slider)
                @if(1 == $slider['thumbnail_type'])
                    <li><div class="overlay-video"><video autoplay="" loop="" muted=""><source src="{{ Storage::url($slider['thumbnail']) }}" type="video/mp4"></video></div><div class="overlay-color"></div>
                @else
                                ...
                                <div class="slider-text-inner">
                                    <div class="desc">
                                        ...
                                        @if (!empty($slider['btn_title']))
                                            <div class="btn-contact"><a href="{{ $slider['btn_url'] }}" target="_blank"><span>{{ $slider['btn_title'] }}</span></a></div>
                                        @endif
                                    </div>
                                </div>
                            </div>
