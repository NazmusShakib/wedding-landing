...
@section('body')
    ...
    <div class="about-section pt-0 pb-60">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 animate-box" style="margin-bottom: 30px" data-animate-effect="fadeInLeft"> <img src="{{ Storage::url($service['thumbnail']) }}" class="img-fluid mb-30" alt=""> </div>
