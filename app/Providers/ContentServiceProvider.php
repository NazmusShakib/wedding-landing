...
{
    public $home_sliders, $contact_us_sliders, $services;
    ...
    {
        $this->home_sliders = Slider::select('id', 'thumbnail_type', 'short_title', 'title', 'description', 'thumbnail', 'btn_title', 'btn_url')
            ->where('page', 'home')->published()->displayOrderd()->get()->toArray();
        $this->contact_us_sliders = Slider::select('id', 'thumbnail_type', 'short_title', 'title', 'description', 'thumbnail', 'btn_title', 'btn_url')
            ->where('page', 'contact_us')->published()->displayOrderd()->get()->toArray();
        ...
        view()->composer('pages.section.slider', function ($view) {
            $view->with(['sliders' => $this->home_sliders]);
        });

        view()->composer('pages.contactUs', function ($view) {
            $view->with(['sliders' => $this->contact_us_sliders]);
        });
